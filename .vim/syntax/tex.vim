...
if exists("g:tex_verbspell") && g:tex_verbspell
 ...
 syn region texZone		start="\\begin{tsllisting}"		end="\\end{tsllisting}\|%stopzone\>"	contains=@Spell
 " moreverb package:
 ...
 syn region texZone		start="\\begin{tsllisting}"		end="\\end{tsllisting}\|%stopzone\>"
 " moreverb package:
