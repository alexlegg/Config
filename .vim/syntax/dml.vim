" Vim syntax file
" Language:	DML
" Maintainer:	Alex legg
" Last Change:	2011 Jul 7
" Mostly stolen from default C
...
syn keyword	cStatement	goto break return continue asm method
...
if !exists("c_no_c99") " ISO C99
  ...
  syn match     cType           display "uint[0-9]*"
...
syn keyword	cStructure	struct union enum typedef register connect bank implement field
syn keyword	cStorageClass	static auto volatile extern const constant data parameter device
if exists("c_gnu")
...
syn match	cInclude	display "^\s*import\s*["<]" contains=cIncluded
"syn match cLineSkip	"\\$"
